...
* using complex numbers and following Reed Solomon Codes.
* The program ask for total points(m) ,max. error points(t)
* and initial points(n).
...
int main()
{
	...
	cout<<"Please enter points for complex field\n";
	cout<<"Also enter real part first and then complex part\n";
